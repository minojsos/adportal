    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h3><i class="fas fa-ad"></i> Edit Category</h3>
                        ...
                        ?>
                        <br />
                        <form action="<?php echo base_url('category/store');?>" name="edit-categoryObj" id="edit-categoryObj" method="post" accept-charset="utf-8">

                            <input type="hidden" name="category_id" class="form-control" id="category_id" value="<?php echo $categoryObj['id']; ?>">

                            <div class="form-group">
                                <label for="category_name">Category Name</label>
                                <input type="text" name="category_name" class="form-control" id="category_name" placeholder="Please enter category name" value="<?php echo $categoryObj['category_name']; ?>">
                            </div>
                            
                            <div class="form-group">
                                <label for="category_desc">Category Description</label>
                                <input type="text" name="category_desc" class="form-control" id="category_desc" placeholder="Please enter category description" value="<?php echo $categoryObj['category_desc']; ?>">
                            </div>

                            <div class="form-group">
                                <button type="submit" id="send_form" class="btn btn-primary">Update Category</button>
                            </div> 
                        </form>
                    </div>
                </div>
